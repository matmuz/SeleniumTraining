...
public class TooltipTest extends BaseTest {
    ...
    public void tooltipTest(){
        ...
        actions.moveToElement(driver.findElement(By.cssSelector("a[title=\"That's what this widget is\"]"))).build().perform();
        ...
        actions.moveToElement(driver.findElement(By.cssSelector("a[title=\"ThemeRoller: jQuery UI's theme builder application\"]"))).build().perform();
